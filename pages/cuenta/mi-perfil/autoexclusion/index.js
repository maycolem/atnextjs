...
import AutoExclusion from 'components/miPerfil/steps/autoexclusion/AutoExclusion'
...
const MyProfile = () => {
  ...
  return (
    <>
      <Head>
          <title>Autoexclusion  | Apuesta Total</title>
      </Head>

      <StyledS>
          <ScrollMenuPage
            active={_CUENTA_MY_PROFILE.CUENTA_MY_PROFILE_AUTOEXCLUSION.url}
            tabs={Object.values(_CUENTA_MY_PROFILE)}
          />
          <ContextPannelsAtS>
            <AutoExclusion></AutoExclusion>
          </ContextPannelsAtS>
      </StyledS>
