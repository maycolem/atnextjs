...
import CambioClave from 'components/miPerfil/steps/cambio-clave/CambioClave'
...
const MyProfile = () => {
  ...
  return (
    ...
    <>
      ...
      <Head>
          <title>Password  | Apuesta Total</title>
      </Head>

      <StyledS>
        <ScrollMenuPage
          active={_CUENTA_MY_PROFILE.CUENTA_MY_PROFILE_CAMBIAR_CONTRASEÑA.url}
