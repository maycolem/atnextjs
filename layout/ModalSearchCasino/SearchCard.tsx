...
export const SearchCard = ({ lobby, pathname, section }: Props) => {
    ...
    return (
        <StyledCard onClick={handlePlay} $column={lobbyTagSlice(lobby_tag, 0, 1)} $row={lobbyTagSlice(lobby_tag, 2, 3)} title={name}>
