...
const SidebarMenu = ({ onClose }) => {
  ...
  return (
    <div className="w-full h-screen bg-blackComplete fixed top-0 left-0 z-20 px-12 text-white ">
      <div className="mx-auto my-12 z-30" style={{ maxWidth: '500px' }}>
        <div className="w-full flex justify-end items-center">
          <button className="bg-transparent" onClick={onClose} style={{ width: '30px', height: '30px' }} type="button">
