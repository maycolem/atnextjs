...
const UserMenu = ({ onClose = () => null, className, isOpenUserMenu, socketBonusActive, handleOpenAway = () => null }: Props) => {
    ...
    const { value: valueSaldo } = useSelector(ShowSaldoSelector)
            ...
            <Styled $isOpenUserMenu={isOpenUserMenu} className={className}>
                <div className="wrapper">
                    ...
                    <Link href={PATHS.CUENTA_MY_PROFILE.url} legacyBehavior>
                        <StyledLinkContent
                            className={classNames({ active: pathname.includes('mi-perfil') })}
                            onClick={() => {
                                handleOpenAway()
                    ...
                    <Link href={PATHS.CUENTA_RECARGA.url} legacyBehavior>
                        <StyledLinkContent
                            className={classNames({ active: pathname.includes('recargar') })}
                            onClick={() => {
                    ...
                    {!!user?.verified && (
                        <Link href={PATHS.CUENTA_RETIRO.url} legacyBehavior>
                            <StyledLinkContent
                                className={classNames({ active: pathname.includes('retirar') })}
                                onClick={() => {
                    ...
                    <Link href={PATHS.CUENTA_BONOS_Y_TORNEOS_BONOS.url} legacyBehavior>
                        <StyledLinkContent
                            ...
                            className={classNames({ active: pathname.includes('bonos-y-torneo') })}
                            onClick={() => {
                                handleCloseAnimated()
...
const Styled = styled.div<PropsStyled>`
    ...
    & {
        .wrapper {
            ...
            position: relative;
            background: ${(p) => p.theme.palette.alternate10.main};
            background: white;
            padding: 3px;
            gap: 3px;
