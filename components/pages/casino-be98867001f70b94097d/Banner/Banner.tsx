...
export const Banner = ({ container, section }) => {
    ...
    const dtCasinoBannersView = (title, section, index) => {
        if (!viewBanners.includes(title)) {
            ...
            dtBannerView(title, section) // silce 47
        }
        ...
        <>
            <HomeBannerS className="react-slick-at">
                <StyledSlides
                    ...
                    //     // const parent = document.querySelector('.react-slick-at')
                    //     // const sliders = document.querySelectorAll('.slick-slide')
                    //     // sliders.forEach((slide) => {
                    //     //     slide.classList.remove('at-prev')
                    //     //     slide.classList.remove('at-next')
                    //     //     slide.classList.remove('at-active')
                    //     // })
                    //     // const active = parent.querySelector('.slick-slide.slick-active') as HTMLDivElement
                    //     // const prev = active.previousElementSibling as HTMLDivElement
                    //     // const next = active.nextElementSibling as HTMLDivElement
                    //     // prev.classList.add('at-prev')
                    //     // next.classList.add('at-next')
                    //     // active.classList.add('at-active')
                    // }}
                    // beforeChange={function (old, newIndex) {
                    //     console.log(old)
                    ...
                    {banners?.length > 0 &&
                        banners?.map(({ config }, i) => (
                            ...
                            >
                                ...
                                <StyledShadow />
                                <StyledButton
                                    // onClick={() => handleOnclick(config?.url, config?.title)}
...
const StyledSlides = styled(Slider)`
    ...
    & {
        ...
        .slick-track > .slick-slide.slick-active ~ .slick-slide {
            transform: scale(0.9);
